...
public extension UIView {
     ...
     */
     func makeToast(_ message: String?, duration: TimeInterval = 2.0, position: ToastPosition = .bottom, title: String? = nil, image: UIImage? = nil, style: ToastStyle? = nil, completion: ((_ didTap: Bool) -> Void)?) {
